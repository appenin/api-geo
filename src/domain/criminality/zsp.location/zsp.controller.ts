...
export class ZspController {
  constructor(private readonly zspService: ZspService = ZspService.create()) {}

  async getZspByCoordinateLocation(request: Request, h: ResponseToolkit) {
